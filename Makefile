...
SOURCES = \
	__init__.py \
	reservoir_creator.py reservoir_creator_dialog.py

PLUGINNAME = reservoir_creator

PY_FILES = \
	__init__.py \
	reservoir_creator.py reservoir_creator_dialog.py

UI_FILES = reservoir_creator_dialog_base.ui
...
QGISDIR=C:\Users\gurbuz\AppData/Roaming/QGIS/QGIS3/profiles/default/python/plugins
